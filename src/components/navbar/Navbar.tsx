            ...
            <nav className="pl-60 pr-20 flex justify-between items-center p-1 bg-charcoal rounded-b-xl">
                ...
                <div className="flex space-x-12 ">
                    ...
                    <div className="relative group">
                        <span className="  cursor-pointer text-2xl text-white hover:text-lime-green transition duration-300">Produtos</span>

                        <div className="absolute  opacity-0 group-hover:opacity-100 mt-2 space-y-2 bg-offwhite rounded-md transition-opacity duration-500 ease-in-out">
                            <Link
                                to="/produtos"
                    ...
                    <div className="relative group">
                        ...
                        <span
                            className="cursor-pointer text-2xl text-white hover:text-lime-green transition duration-300"
                        >
                            Categorias
                        </span>
